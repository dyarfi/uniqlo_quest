...
<div class="portlet box green"  data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="portlet-title">
        <div class="caption"><i class="icon-globe"></i>Data <?php echo $subject ?></div>
        <div class="tools">
            <?php if (!$unset_add) { ?>
                <a href="<?php echo $add_url ?>" class="btn blue"><i class="icon-pencil"></i> <?php echo $this->l('list_add'); ?> <?php echo $subject ?></a>
            <?php } ?>
        </div>
    </div>
    <div class="portlet-body flip-scroll">
        ...
        <div style="margin-top:5px">
            <?php echo $this->l('list_search'); ?>: <input type="text" class="qsbsearch_fieldox search_text" name="search_text" size="30" id='search_text' style="margin-bottom: 0px">
            <select name="search_field" id="search_field" style="margin-bottom: 0px">
