...
class image_CRUD {
    ...
    protected function _get_photos($relation_value = null) {
        ...
        foreach ($results as $num => $row) {
            $url_field = $row->{$this->url_field};

            if (!file_exists($this->image_path . '/' . $this->thumbnail_prefix . $url_field)) {
                $this->_create_thumbnail($this->image_path . '/' . $url_field, $this->image_path . '/' . $this->thumbnail_prefix . $url_field);
            }
            $results[$num]->image_url = base_url() . $this->image_path . '/' . $url_field;
            $results[$num]->thumbnail_url = base_url() . $this->image_path . '/' . $this->thumbnail_prefix . $url_field;
